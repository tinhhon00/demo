    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h4>Khách hàng</h4>
                <?php
                    $sql_select = mysqli_query($mysqli,"SELECT * FROM tbl_khachhang,tbl_giaodich WHERE tbl_khachhang.khachhang_id=
                    tbl_giaodich.khachhang_id GROUP BY tbl_giaodich.magiaodich ORDER BY tbl_khachhang.khachhang_id DESC");
                ?>
            ...
            <div class="col-md-12">
                ...
                <?php
                    ...
                    $sql_select = mysqli_query($mysqli,"SELECT * FROM tbl_giaodich, tbl_khachhang,tbl_sanpham WHERE tbl_giaodich.sanpham_id=tbl_sanpham.sanpham_id 
