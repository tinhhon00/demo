<?php
	...
	$sql_product = mysqli_query($mysqli,"SELECT * FROM tbl_sanpham,tbl_category WHERE sanpham_name LIKE '%$tukhoa%' OR category_name LIKE '%$tukhoa%' GROUP BY sanpham_id DESC");
