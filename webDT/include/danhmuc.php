	...
	$sql_cate = mysqli_query($mysqli,"SELECT * FROM tbl_category, tbl_sanpham WHERE tbl_category.category_id=tbl_sanpham.category_id 
	AND tbl_sanpham.category_id='$id' ORDER BY tbl_sanpham.sanpham_id DESC");
	
	$sql_category = mysqli_query($mysqli,"SELECT * FROM tbl_category, tbl_sanpham WHERE tbl_category.category_id=tbl_sanpham.category_id 
	AND tbl_sanpham.category_id='$id' ORDER BY tbl_sanpham.sanpham_id DESC");
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<form action="?quanly=giohang" method="post">
												<fieldset>
													...
													<input type="hidden" name="giasanpham" value="<?php echo $row_sanpham['sanpham_giakm'] ?>" />
					...
					<div class="side-bar p-sm-4 p-3">
						<div class="search-hotel border-bottom py-2">
							...
							<form action="#" method="post">
								<input type="search" placeholder="Sản phảm..." name="search" required="">
						...
						<div class="f-grid py-2">
							...
							<div class="box-scroll">
								<div class="scroll">
									<?php
										$sql_product_sidebar = mysqli_query($mysqli,"SELECT * FROM tbl_sanpham WHERE sanpham_hot = '1' ORDER BY sanpham_id DESC");
									...
									<div class="row">
										...
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											...
											<a href="" class="price-mar mt-2"><?php echo number_format($row_sanpham_sidebar['sanpham_giakm']).'vnđ' ?></a>
