<?php
	...
	$slq_chitiet = mysqli_query($mysqli, "SELECT * FROM tbl_sanpham WHERE sanpham_id = '$id' ");
?>
...
<div class="services-breadcrumb">
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
					...
					<?php
					$sql_tensp = mysqli_query($mysqli,"SELECT * FROM tbl_sanpham WHERE sanpham_id='$id'");
					$row_sp_title =mysqli_fetch_array($sql_tensp);
					?>
					<li><?php echo $row_sp_title['sanpham_name'] ?></li>
				</ul>
			</div>
		</div>
	</div>
	<!-- //page -->
	<?php
		while($row_chitiet = mysqli_fetch_array($slq_chitiet)){
	?>
    <!-- Single Page -->
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					...
					<p class="mb-3">
						<span class="item_price"><?php echo number_format($row_chitiet['sanpham_giakm']). 'vnđ' ?></span>
						...
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							<form action="?quanly=giohang" method="post">
								<fieldset>
									...
									<input type="hidden" name="giasanpham" value="<?php echo $row_chitiet['sanpham_giakm'] ?>" />
