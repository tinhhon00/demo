                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php
                                    ...
                                    $sql_select = mysqli_query($mysqli,"SELECT * FROM tbl_giaodich WHERE tbl_giaodich.khachhang_id='$id_khachhang' GROUP BY tbl_giaodich.magiaodich ");
                                ?>
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            &magiaodich=<?php echo $row_donhang['magiaodich'] ?>&huydon=1">Yêu cầu hủy</a></td>
                                            <?php
