<?php
	if(isset($_POST['themgiohang'])){
		...
		$sql_khachhang = mysqli_query($mysqli,"INSERT INTO tbl_khachhang(name,phone,email,address,note,giaohang,password) values ('$name','$phone','$email','$address','$note','$giaohang','$password')");
		if($sql_khachhang){
			...
			for($i=0;$i<count($_POST['thanhtoan_product_id']); $i++){
				...
				$sql_donhang = mysqli_query($mysqli, "INSERT INTO tbl_donhang(sanpham_id,khachhang_id,soluong,mahang) values ('$sanpham_id','$khachhang_id','$soluong','$mahang')");
					...
					<form action="" method="post" class="creditly-card-form agileinfo_form">
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								<div class="first-row">
									...
									<div class="controls form-group">
										<select class="option-w3ls" name="giaohang">
											<option>Chọn hình thực thanh toán</option>
								...
								?>
								<input type="submit" name= "thanhtoan" class="btn btn-success" style="width: 25%" value="Thanh toán">
							</div>
						</div>
					</form>
				</div>
